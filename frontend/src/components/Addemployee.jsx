            ...
            <div className='d-flex justify-content-center align-items-center mt-3'>
                <div className='p-5 rounded w-50 border'>
                    ...
                    <form className='row g-1' onSubmit={handleSubmit}>
                        ...
                        <div className='col-12'>
                            <label htmlFor='inputEmail14' className='form-label'><strong>Email:</strong></label>
                        ...
                        <div className='col-12'>
                            <label htmlFor='inputPassword64' className='form-label'><strong>Password:</strong></label>
                        ...
                        <div className='col-12'>
                            <label htmlFor='category' className='form-label'><strong>Department:</strong></label>
